	...
	<view>
		<view class="animate-wrap">
			<view style="position: fixed;"
			 v-for="(item,index) in viewList" :key="item.elId"
			 :ref="item.elId"
			 :style="{
				...
				<image
				 ...
				 :src="item.src"
				 mode="widthFix"
				 :animation="item.animation"></image>
			</view>
		</view>
		<view class="on-button">
			<image v-if="!$slots.default"
			 :style="{
			 	'width': width + 'rpx',
			 	'height': height + 'rpx'
			 }"
...
<script>
	export default {
		props: {
			src: {
				type: String,
				default: 'https://6e69-niew6-1302638010.tcb.qcloud.la/%E6%B0%94%E6%B3%A1/%E7%82%B9%E8%B5%9E-%E5%B0%8F%E7%BA%A2%E5%BF%83.png?sign=340cd58768270d0c96562c35ca01e943&t=1604037369'
			},
			showImgs: { // 显示图标路径
				type: Array,
				default: () => {
